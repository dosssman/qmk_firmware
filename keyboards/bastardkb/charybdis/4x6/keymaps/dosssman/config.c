...
/* RTS Layers:
  - Sacrifices desktop navigations to have more access to control groups
  - more convenient Shift and Control positions for control group creations
  - replaces mouse keys on the left side with corresponding keys from the right (as if mirroring) for more shortcuts access
*/
...
/* FPS layers:
  - replaces mouse keys on the left side with corresponding keys from the right (as if mirroring) for more shortcuts access
*/
#define LAYER_6 6 // FPS Base Layer 0
#define LAYER_7 7 // FPS Focused Layer 1
#define LAYER_8 8 // FPS Focused Layer 2
