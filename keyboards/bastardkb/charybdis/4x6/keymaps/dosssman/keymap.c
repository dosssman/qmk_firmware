...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT(KC_F12, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_GRV, KC_P, KC_O, KC_UP, KC_U, KC_LBRC, KC_RBRC, KC_BTN1, KC_BTN3, KC_BTN2, KC_TRNS, KC_EQL, KC_TRNS, KC_SCLN, KC_LEFT, KC_DOWN, KC_RGHT, KC_H, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_BSLS, KC_TRNS, KC_TRNS, KC_SLSH, KC_COMM, KC_DOT, KC_M, KC_HOME, KC_END, KC_LALT, KC_SPC, DPI_MOD, S_D_MOD, KC_TRNS, KC_LSFT, KC_NO, KC_NO, KC_DEL, SNP_TOG, KC_ENT, LT(5,KC_NO), LT(5,KC_NO)),
